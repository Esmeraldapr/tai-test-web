// ============================================================
// Lógica de "Ley 40/2015, régimen jurídico sector público" (ley40-2015.html)
...
const ARTICULOS_EN_EXAMEN = {
  "55": [{ anio: "2018", sobre: "qué órganos NO tienen la condición de alto cargo" }],
  "156": [{ anio: "2018", sobre: "definición del Esquema Nacional de Interoperabilidad" }],
};
...
(async function iniciar() {
  ...
  let datos;
  try {
    const res = await fetch("data/ley40-2015.json");
    if (!res.ok) throw new Error("HTTP " + res.status);
    datos = await res.json();
  } catch (e) {
    console.error("Error cargando ley40-2015.json:", e);
