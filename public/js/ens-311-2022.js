// ============================================================
// Lógica de "ENS, RD 311/2022" (ens-311-2022.html)
...
// Esquema Nacional de Seguridad sin recortes, así que entra entero. Por eso
// aquí no hay lista de qué entra y qué no, como sí la tienen las otras dos.
...
(async function iniciar() {
  ...
  let datos;
  try {
    const res = await fetch("data/ens-311-2022.json");
    if (!res.ok) throw new Error("HTTP " + res.status);
    datos = await res.json();
  } catch (e) {
    console.error("Error cargando ens-311-2022.json:", e);
  ...
  conectarBuscador("buscar-medidas", ".tabla-medidas tbody tr", "contador-medidas");
