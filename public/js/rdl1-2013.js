// ============================================================
// Lógica de "RDL 1/2013, discapacidad" (rdl1-2013.html)
// Pinta el texto consolidado (Títulos → Capítulos → Secciones → Artículos,
// Disposiciones) a partir de data/rdl1-2013.json. El lector de voz (con
...
// Esta es la ley española que regula la discapacidad, así que se da por que
// entra entera.
// El tema 5 lo forman CINCO leyes; LO 3/2007 (igualdad), Ley 39/2006
// (dependencia), LO 1/2004 (violencia de género) y Ley 4/2023 (LGTBI) ya
// están montadas. Esta es la quinta y última: con ella se cierra el tema 5.
...
(async function iniciar() {
  ...
  let datos;
  try {
    const res = await fetch("data/rdl1-2013.json");
    if (!res.ok) throw new Error("HTTP " + res.status);
    datos = await res.json();
  } catch (e) {
    console.error("Error cargando rdl1-2013.json:", e);
