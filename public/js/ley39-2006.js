// ============================================================
// Lógica de "Ley 39/2006, dependencia" (ley39-2006.html)
// Pinta el texto consolidado (Títulos → Capítulos → Secciones → Artículos,
// Disposiciones) a partir de data/ley39-2006.json, con lector de voz en cola
...
// Esta es la ley española que regula la dependencia, así que se da por que
// entra entera.
// El tema 5 lo forman CINCO leyes; la LO 3/2007 (igualdad) fue la primera que
// se montó. Esta es la de dependencia. Faltan la LO 1/2004 (violencia de
// género), la Ley 4/2023 (LGTBI) y el RDL 1/2013 (discapacidad).
...
(async function iniciar() {
  ...
  let datos;
  try {
    const res = await fetch("data/ley39-2006.json");
    if (!res.ok) throw new Error("HTTP " + res.status);
    datos = await res.json();
  } catch (e) {
    console.error("Error cargando ley39-2006.json:", e);
