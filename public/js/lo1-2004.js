// ============================================================
// Lógica de "LO 1/2004, violencia de género" (lo1-2004.html)
// Pinta el texto consolidado (Títulos → Capítulos → Secciones → Artículos,
// Disposiciones) a partir de data/lo1-2004.json, con lector de voz en cola
...
// Esta es la ley española que regula la violencia de género, así que se da
// por que entra entera.
// El tema 5 lo forman CINCO leyes; LO 3/2007 (igualdad) y Ley 39/2006
// (dependencia) ya están montadas. Esta es la tercera. Faltan la Ley 4/2023
// (LGTBI) y el RDL 1/2013 (discapacidad).
...
(async function iniciar() {
  ...
  let datos;
  try {
    const res = await fetch("data/lo1-2004.json");
    if (!res.ok) throw new Error("HTTP " + res.status);
    datos = await res.json();
  } catch (e) {
    console.error("Error cargando lo1-2004.json:", e);
